function clearAll() {
  ...
  const joke = document.querySelector(".joke-display");
  const quote = document.querySelector(".quote-display");
  const riddle = document.querySelector(".riddle-display");
  meme.innerHTML="";
  joke.innerHTML="";
  quote.innerHTML="";
  riddle.innerHTML="";
...
function showMeme() {
  ...
  newEle.setAttribute("src",randomMemeUrl);
  newEle.setAttribute("alt","Programmer Meme");
  meme.appendChild(newEle);
}
...
function showRiddle() {
  ...
  const riddleContainer = document.querySelector(".riddle-display");
...
function revealAnswers() {
    const riddleContent = document.querySelector(".riddle-display");
